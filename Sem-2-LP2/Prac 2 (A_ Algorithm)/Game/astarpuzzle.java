...
public class astarpuzzle {
    ...
    static void print(int[] puzzle) {
        for (int i = 0; i < 9; i++) {
            if (i % 3 == 0)
                System.out.println(); // Start a new line for every 3 elements
            if (puzzle[i] == -1)
                System.out.print("_ "); // Print "_" for the empty tile
            else
                System.out.print(puzzle[i] + " "); // Print the number for non-empty tiles
        }
        System.out.println("\n");
    }

    // Method to move the empty tile to the left
    ...
    // Method to move the empty tile to the right
    ...
    // Method to move the empty tile up
    ...
    // Method to move the empty tile down
    ...
    // Method to copy the puzzle state
    ...
    static int heuristic(int[] start, int[] goal) {
        ...
        return h + g; // Add the cost of reaching the current state
    }

    // Method to move the empty tile based on the A* algorithm
